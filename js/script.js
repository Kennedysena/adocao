...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const responses = {
        ...
        "adotar": "Para adotar um pet, acesse a seção de adoção ou clique no botão abaixo para falar conosco no WhatsApp.",
        "contato": "Você pode nos enviar uma mensagem pelo formulário ou pelo nosso WhatsApp.",
        "whatsapp": "Clique aqui para conversar conosco no WhatsApp: <a href='https://wa.me/559299084185?text=Olá! Gostaria de mais informações.' target='_blank'>Falar no WhatsApp</a>"
    };
    ...
    sendMessage.addEventListener("click", () => {
        ...
        if (userMessage) {
            ...
            // Responder mensagem
            const botResponse = responses[userMessage] || "Desculpe, não entendi. Você pode perguntar sobre adoção ou contato!";
